...
#+begin_quote
  This page will not be updated any more. The reason is that I found my
  kid learns too quickly, and I must see him as a fellow but not a kid
  any more. Now we follow the "Mathematics Trench" outline to learn. You
  can search it on Google if you are interested.
#+end_quote
