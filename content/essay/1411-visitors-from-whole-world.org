...
#+CALL: image[:results value](path="2014/11/visitors-map.png", width=634, caption="地图") :results raw

#+CALL: image[:results value](path="2014/11/visitors-list.png", width=768, caption="国家/地区列表") :results raw
